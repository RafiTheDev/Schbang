  ...
  return (
    <div>
      ...
      <div className="text-center mt-3">
        <p className="font-bold text-3xl my-2">Have you got what it takes to #CreateASchbang?<br /></p>
        <p className="text-xl font-medium">Check out our core principles. If they align with your values, do apply..</p>
      </div>
    </div>
